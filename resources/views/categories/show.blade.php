...
@section('content')
    <div class="bg-gray-100 p-10 shadow">
        <h1 class="w-full my-2 text-3xl font-normal leading-tight text-center text-gray-700 pt-5">
            Ofertas disponibles para: <span class="font-semibold">{{ $category->name }}.</span>
        </h1>
        <div class="w-full">
            ...
            <div class="bg-teal-100 border-l-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 rounded-lg shadow-lg mx-auto w-3/4 mt-10" role="alert">
                <div class="flex">
                    ...
                    <div>
                        ...
                        <p class="text-md">{{ $category->name }} aún no tiene ofertas disponibles.</p>
                    </div>
                </div>
            </div>
        @endif
