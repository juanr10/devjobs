...
<div class="w-full flex flex-wrap">
    <div class="w-full md:w-1/2 flex flex-col">
        <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
            ...
            <p class="text-center text-2xl text-black">Regístrese y empiece a publicar vacantes.</p>

            <form class="flex flex-col pt-3 md:pt-8" method="POST" action="{{ route('register') }}" novalidate>
                @csrf
                ...
                <input type="submit" value="Registrar"
                    class="w-full mt-6 px-4 py-2 text-base font-semibold text-center text-white transform transition hover:scale-105 duration-300 ease-in-out bg-teal-500 shadow-md hover:bg-teal-600 focus:outline-none focus:ring-2">
            </form>
